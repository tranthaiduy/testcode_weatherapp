...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 28, 2024 lúc 05:35 PM
...
INSERT INTO `tbl_history` (`id`, `location`, `temperature`, `wind`, `humidity`) VALUES
(1, 'Ho Chi Minh', '29', '5.6', '84'),
(2, 'Ha Noi', '24', '4.3', '89'),
(3, 'New york', '8.9', '8.1', '89'),
(4, 'London', '10', '18.6', '82'),
(5, 'Bangkok', '31', '8.1', '63'),
(6, 'Miami', '27.8', '11.9', '74');
...
INSERT INTO `tbl_notification` (`id`, `email`, `confirmed`, `created_at`, `updated_at`) VALUES
(2, 'caghegiama@gmail.com', 0, '2024-03-28 15:49:07', '2024-03-28 15:49:07');
